...
Junteng Liu, Yuanxiang Fan, Zhuo Jiang, Han Ding, Yongyi Hu, Chi Zhang, Yiqi Shi, Shitong Weng, Aili Chen, Shiqi Chen, Yunan Huang, Mozhi Zhang, Pengyu Zhao, Junjie Yan, Junxian He. *Arxiv*, 2025. (First author) Code is available on GitHub.

**On the Perception Bottleneck of VLMs for Chart Understanding**

Junteng Liu, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. *Arxiv*, 2025. (First author) Code (Vision4Chart) is available on GitHub.

**On the Universal Truthfulness Hyperplane Inside LLMs**

Junteng Liu, Shiqi Chen, Yu Cheng, Junxian He. *EMNLP 2024*. (First author) Code (Universal_Truthfulness_Hyperplane) is available on GitHub.
